...
const DE: TrayStrings = TrayStrings {
    ...
    account: "Konto",
    new_chat: "Neuer Chat",
    open_app: "Zhimind öffnen",
    quit: "Zhimind beenden",
    tooltip: "Zhimind",
    close: "Schließen",
...
const ES: TrayStrings = TrayStrings {
    ...
    account: "Cuenta",
    new_chat: "Nuevo chat",
    open_app: "Abrir Zhimind",
    quit: "Salir de Zhimind",
    tooltip: "Zhimind",
    close: "Cerrar",
...
const FIL: TrayStrings = TrayStrings {
    ...
    open_app: "Buksan ang Zhimind",
    quit: "Isara ang Zhimind",
    tooltip: "Zhimind",
    close: "Isara",
...
const FR: TrayStrings = TrayStrings {
    ...
    open_app: "Ouvrir Zhimind",
    quit: "Quitter Zhimind",
    tooltip: "Zhimind",
    close: "Fermer",
...
const ID: TrayStrings = TrayStrings {
    ...
    open_app: "Buka Zhimind",
    quit: "Keluar dari Zhimind",
    tooltip: "Zhimind",
    close: "Tutup",
...
const IT: TrayStrings = TrayStrings {
    ...
    account: "Account",
    new_chat: "Nuova chat",
    open_app: "Apri Zhimind",
    quit: "Esci da Zhimind",
    tooltip: "Zhimind",
    close: "Chiudi",
...
const PT_BR: TrayStrings = TrayStrings {
    ...
    open_app: "Abrir o Zhimind",
    quit: "Sair do Zhimind",
    tooltip: "Zhimind",
    close: "Fechar",
    usage_with_reset: "Uso  ·  {pct}% restante  ·  {time}",
    usage_pct: "Uso  ·  {pct}% restante",
...
const RU: TrayStrings = TrayStrings {
    ...
    account: "Аккаунт",
    new_chat: "Новый чат",
    open_app: "Открыть Zhimind",
    quit: "Выйти из Zhimind",
    tooltip: "Zhimind",
    close: "Закрыть",
...
const TA: TrayStrings = TrayStrings {
    ...
    open_app: "Zhimind ஐத் திற",
    quit: "Zhimind இலிருந்து வெளியேறு",
    tooltip: "Zhimind",
    close: "மூடு",
...
const UK: TrayStrings = TrayStrings {
    ...
    new_chat: "Новий чат",
    open_app: "Відкрити Zhimind",
    quit: "Вийти з Zhimind",
    tooltip: "Zhimind",
    close: "Закрити",
