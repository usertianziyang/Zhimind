...
export const zhCore = {
  ...
  "app.versionFooter": "Zhimind v0.2.31 · MIT · 非 xAI 官方 · 姐妹项目 grok-go",
  "window.minimize": "最小化",
  "window.maximize": "最大化",
  "window.restore": "还原",
  "window.close": "关闭",
  ...
  "app.quitBusy.automationsNote": "已开启的已安排任务会在退出后暂停，直到你再次打开 Zhimind。没有独立的后台守护进程。",
  "app.quitBusy.automationsNoteLogin": "已开启的已安排任务会在退出后暂停；「登录时启动」会在你下次登录后重新打开 Zhimind（不会立刻重启）。",
  ...
  "notify.turnDoneTitle": "Zhimind 已完成一轮",
  ...
  "endOfTurn.cliUpgrade": "已停止 — Zhimind Runtime 已升级",
  ...
  "tray.account": "账户",
  "tray.newChat": "新对话",
  "tray.openApp": "打开 Zhimind",
  "tray.quit": "退出 Zhimind",
  ...
  "skillsPicker.hostOnlyHint": "技能需要桌面宿主与 Zhimind Runtime。请检查「设置 → CLI / 运行时」。",
