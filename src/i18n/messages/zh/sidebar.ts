...
export const zhSidebar = {
  ...
  "sidebar.importCliSessions": "从 Zhimind Runtime 导入",
  "sidebar.importCliSessionsHint": "Zhimind Runtime 对话仍在 ~/.grok，导入后才会出现在侧栏。",
  ...
  "sidebar.remoteDeleteConfirm": "确定永久删除 {alias} 上的「{name}」？远程 Zhimind 会话会被删掉。",
