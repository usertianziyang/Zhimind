...
export const enCore = {
  ...
  "app.versionFooter": "Zhimind v0.2.31 · MIT · Unofficial · Sister project grok-go",
  ...
  "cliUpdate.notice": "Zhimind Runtime {current} → {latest} available",
  ...
  "app.quitBusy.automationsNote": "Enabled scheduled tasks will pause after quit until you reopen Zhimind. There is no separate background daemon.",
  "app.quitBusy.automationsNoteLogin": "Enabled scheduled tasks pause after quit; Launch at login will restart Zhimind after your next sign-in (not immediately).",
  ...
  "notify.turnDoneTitle": "Zhimind finished a turn",
  ...
  "endOfTurn.cliUpgrade": "Stopped — Zhimind Runtime was updated",
  ...
  "tray.openApp": "Open Zhimind",
  "tray.quit": "Quit Zhimind",
  ...
  "skillsPicker.hostOnlyHint": "Skills need the desktop host and Zhimind Runtime. Check Settings → CLI / Runtime.",
