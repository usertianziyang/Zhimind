...
export const enSidebar = {
  ...
  "sidebar.importCliSessions": "Import from Zhimind Runtime",
  "sidebar.importCliSessionsHint": "Zhimind Runtime chats stay under ~/.grok until you import them here.",
  ...
  "sidebar.remoteDeleteConfirm": "Permanently delete “{name}” on {alias}? The remote Zhimind session is removed.",
