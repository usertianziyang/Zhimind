...
export const zhTWSidebar = {
  ...
  "sidebar.importCliSessions": "從 Zhimind Runtime 匯入",
  "sidebar.importCliSessionsHint": "Zhimind Runtime 對話仍在 ~/.grok，匯入後才會出現在側欄。",
  ...
  "sidebar.remoteDeleteConfirm": "確定永久刪除 {alias} 上的「{name}」？遠端 Zhimind 會話會被刪掉。",
