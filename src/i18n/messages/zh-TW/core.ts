...
export const zhTWCore = {
  ...
  "app.versionFooter": "Zhimind v0.2.30 · MIT · 非 xAI 官方 · 姊妹專案 grok-go",
  "window.minimize": "最小化",
  "window.maximize": "最大化",
  "window.restore": "還原",
  "window.close": "關閉",
  ...
  "cliUpdate.notice": "Zhimind Runtime {current} → {latest} 可更新",
  ...
  "app.quitBusy.automationsNote": "已開啟的已排程任務會在結束後暫停，直到你再次開啟 Zhimind。沒有獨立的背景守護行程。",
  "app.quitBusy.automationsNoteLogin": "已開啟的已排程任務會在結束後暫停；「登入時啟動」會在你下次登入後重新開啟 Zhimind（不會立刻重啟）。",
  "app.quitPressAgain": "再按一次結束",
  "common.cancel": "取消",
  "common.confirm": "確認",
  "common.save": "儲存",
  "common.dismiss": "關閉",
  "onboarding.welcome": "歡迎使用 Zhimind",
  ...
  "notify.turnDoneTitle": "Zhimind 已完成一輪",
  ...
  "endOfTurn.cliUpgrade": "已停止 — Zhimind Runtime 已升級",
  ...
  "tray.account": "帳戶",
  "tray.newChat": "新對話",
  "tray.openApp": "開啟 Zhimind",
  "tray.quit": "結束 Zhimind",
  ...
  "skillsPicker.hostOnlyHint": "技能需要桌面宿主與 Zhimind Runtime。請檢查「設定 → CLI / 執行階段」。",
